...
use app\models\KatSuratSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * KatSuratController implements the CRUD actions for KategoriSurat model.
 */
class KatSuratController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new KatSuratSearch();
